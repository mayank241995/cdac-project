        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Email Address Required"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>

...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="Server">
    ...
    <div class="container">
        ...
        <asp:TextBox ID="txtMobile" placeholder="Enter Mobie No." runat="server"></asp:TextBox>
        ...
        <asp:TextBox ID="txtConfirmPassword" placeholder="Enter Confirm Password" runat="server" TextMode="Password"></asp:TextBox>

        <label for="address"><b>Address</b></label>
        <asp:TextBox ID="txtAddress" placeholder="Enter Address" runat="server"></asp:TextBox>

        <label for="area"><b>Area</b></label>
        <asp:TextBox ID="txtArea" placeholder="Enter Area" runat="server"></asp:TextBox>

        <label><asp:CheckBox ID="CheckBox1" runat="server" Checked="True" Text="Remember Me" /></label>
        
        <div class="clearfix">
            
            <asp:Button ID="btnCancle" runat="server" Text="Cancle" Height="48px" Width="423px" />
            
            <asp:Button ID="btnSubmit" runat="server" Text="Submit" Width="532px" Height="49px" />
        </div>
    </div>
